...
`farsight.py` is the most basic and general sample application for Python API of [MRTech IFF SDK](https://mr-te.ch/iff-sdk).
It is located in `samples/01_streaming_py` directory of IFF SDK package.
